...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"node_modules/lib-font/src/opentype/tables/simple/other/vhea.js":[function(require,module,exports) {
"use strict";
 ...
 */
class vhea extends _simpleTable.SimpleTable {
  constructor(dict, dataview) {
    const {
      p
    } = super(dict, dataview);
    this.version = p.fixed; // the next three fields are named as per version 1.0 and version 1.1
...
//# sourceMappingURL=/vhea.f4a25674.js.map