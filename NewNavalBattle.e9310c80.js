...
function initFields() {
  exports.humanField = humanField = new HumanField();
  exports.aiField = aiField = new AiField();
  exports.humanGuessField = humanGuessField = new Field();
  aIguessField = new Field();
  exports.gameIsOver = gameIsOver = false;
}
