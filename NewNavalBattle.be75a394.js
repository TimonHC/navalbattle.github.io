...
var Field = function () {
    function Field() {
        ...
        this.battleField = Array.from({ length: _RESOLUTION }, function () {
            return Array.from({ length: _RESOLUTION }, function () {
                return '@';
            });
        });
    }
...
var PlayerField = function (_Field) {
    _inherits(PlayerField, _Field);

    function PlayerField() {
        _classCallCheck(this, PlayerField);

        var _this = _possibleConstructorReturn(this, (PlayerField.__proto__ || Object.getPrototypeOf(PlayerField)).call(this));
...
var HumanField = function (_PlayerField) {
    _inherits(HumanField, _PlayerField);

    function HumanField() {
        _classCallCheck(this, HumanField);

        return _possibleConstructorReturn(this, (HumanField.__proto__ || Object.getPrototypeOf(HumanField)).call(this));
    }
...
var AiField = function (_PlayerField2) {
    _inherits(AiField, _PlayerField2);

    function AiField() {
        _classCallCheck(this, AiField);

        return _possibleConstructorReturn(this, (AiField.__proto__ || Object.getPrototypeOf(AiField)).call(this));
    }
...
var humanField = exports.humanField = new HumanField();
var aiField = exports.aiField = new AiField();
var humanGuessField = exports.humanGuessField = new Field();
...
//# sourceMappingURL=/NewNavalBattle.be75a394.map